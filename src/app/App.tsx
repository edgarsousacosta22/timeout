...
const App = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans text-slate-900 selection:bg-slate-200">
      ...
      <main className="container mx-auto px-4 py-12 flex flex-col items-center justify-center portrait:justify-start portrait:pt-6 min-h-screen bg-[rgb(255,255,255)] relative">
